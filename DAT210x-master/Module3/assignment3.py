...
#
# .. your code here ..
df = pd.read_csv("/home/abhishar/Desktop/DatS/DAT210x-master/Module3/Datasets/wheat.data")
...
ax.scatter(df.perimeter, df.area, df.asymmetry, c = "r")
#
# TODO: Create a new 3D subplot using fig. Then use the
...
ax.scatter(df.width, df.groove, df.length, c = "g")
plt.show()
