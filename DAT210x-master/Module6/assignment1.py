...
def drawPlots(model, X_train, X_test, y_train, y_test, wintitle='Figure 1'):
  ...
  for col in range(num_columns):
    for row in range(num_columns):
      ...
      score = round(model.score(X_test_bag, y_test) * 100, 5)
...
def benchmark(model, X_train, X_test, y_train, y_test, wintitle='Figure 1'):
  ...
  print "High-Dimensionality Score: ", round((score*100), 5)
...
#
# .. your code here ..
X = pd.read_csv("/home/abhishar/Desktop/DatS/DAT210x-master/Module6/Datasets/wheat.data")
