...
Plot2D(isomap, "Isomap Plot", 0, 1, num_to_plot=40)
...
#
# .. your code here ..
dataT = pd.DataFrame(columns = ['x', 'y', 'z'], data = T)
dataI = pd.DataFrame(columns = ['x', 'y', 'z'], data = isomap)

fig = plt.figure()
ax = fig.gca(projection='3d')
ax.scatter(dataT.x, dataT.y, dataT.z,
