...
def doKMeans(data, clusters=0):
  ...
  print X[:, 0]
  print X[:, 1]
  ax.scatter(X[:, 0], X[:, 1], c='r', marker='x', alpha=0.8)
  model = kmeans
  return model
...
#
# TODO: The idea is that the call was placed before 5pm. From Midnight-730am, the user is
...
ax.scatter(user1.TowerLat, user1.TowerLon, c = 'b', marker = 'o', alpha = 0.8)
