...
#
# .. your code here ..
mat = scipy.io.loadmat('/home/abhishar/Desktop/DatS/DAT210x-master/Module4/Datasets/face_data.mat')
...
#
# .. your code here ..
face_labels = pd.read_csv("/home/abhishar/Desktop/DatS/DAT210x-master/Module5/Datasets/face_labels.csv", header=None)
...
train_data, test_data, train_label, test_label = train_test_split(df, face_labels, test_size = 0.10, random_state = 7)
...
Plot2DBoundary(train_data, train_label, test_data, test_label)
plt.show()
