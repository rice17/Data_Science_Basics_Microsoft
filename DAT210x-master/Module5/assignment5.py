...
#
# .. your code here ..
X = pd.read_csv('/home/abhishar/Desktop/DatS/DAT210x-master/Module5/Datasets/wheat.data')
X.head(5)
...
# .. your code here ..
z = []
order = {'canadian' : 0, 'kama' : 1, 'rosa' : 2}
for i in y:
    z.append(order[i])
#
...
train_data, test_data, train_label, test_label = train_test_split(X, z, test_size = 0.33, random_state = 1)
...
plotDecisionBoundary(knn, train_data, train_label)
