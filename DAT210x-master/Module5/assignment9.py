...
#
# .. your code here ..
X = pd.read_csv("/home/abhishar/Desktop/DatS/DAT210x-master/Module5/Datasets/College.csv", index_col = 0)
...
#
# .. your code here ..
room_board = X.loc[:, ["Room.Board"]]
accepted_students = X.loc[:, "Accept"]
from sklearn.model_selection import train_test_split
X_train, X_test, y_train, y_test = train_test_split(room_board, accepted_students, random_state = 7, test_size = 0.3)
#
...
#
# .. your code here ..
enrolled_students = X.loc[:, "Enroll"]
X_train, X_test, y_train, y_test = train_test_split(enrolled_students, accepted_students, random_state = 7, test_size = 0.3)
X_train = X_train.values.reshape(-1, 1)
y_train = y_train.values.reshape(-1, 1)
X_test = X_test.values.reshape(-1, 1)
y_test = y_test.values.reshape(-1, 1)
...
#
# .. your code here ..
failed_undergrads = X.loc[:, "F.Undergrad"]
X_train, X_test, y_train, y_test = train_test_split(failed_undergrads, accepted_students, random_state = 7, test_size = 0.3)
X_train = X_train.values.reshape(-1, 1)
y_train = y_train.values.reshape(-1, 1)
X_test = X_test.values.reshape(-1, 1)
y_test = y_test.values.reshape(-1, 1)
...
#
# .. your code here ..
complicated = X.loc[:, ['Enroll', 'Room.Board']]
X_train, X_test, y_train, y_test = train_test_split(complicated, accepted_students, random_state = 7, test_size = 0.3)
#X_train = X_train.values.reshape(-1, 1)  Not needed since it is multi-featured
y_train = y_train.values.reshape(-1, 1)
#X_test = X_test.values.reshape(-1, 1)
y_test = y_test.values.reshape(-1, 1)
model.fit(X_train, y_train)
