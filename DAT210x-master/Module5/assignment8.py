...
#
# .. your code here ..
X = pd.read_csv("/home/abhishar/Desktop/DatS/DAT210x-master/Module5/Datasets/life_expectancy.csv", delimiter = "\t")
#
...
drawLine(model, X_train, y_train, "White Male Life Expectancy")
#
# TODO: Print the actual 2014 WhiteMale life expectancy from your
# loaded dataset
#
# .. your code here ..
print X.WhiteMale[X.Year == 1986]
...
y_train = y_train.values.reshape(-1, 1)
model.fit(X_train, y_train)
drawLine(model, X_train, y_train, "Black Female Life Expectancy")
print X.BlackFemale[X.Year == 1986]
#
